...
#include "Component/WindDebugComponent.h"
...
UWindDebugComponent::UWindDebugComponent()
{
...
void UWindDebugComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UWindDebugComponent::InitComponent()
{
...
// Called every frame
void UWindDebugComponent::TickComponent(float DeltaTime, ELevelTick TickType,
                                                FActorComponentTickFunction* ThisTickFunction)
{
	...
	if(SampleRenderTargetObj)
	{
		...
		if(WindMgr)
		{
			...
			UWindDebugLibrary::DrawWindTextureToRT(GetWorld(),Padding,MaxWindVelocity,&WindMgr->GetWindVelocityBuffer(),SampleRenderTargetObj);
