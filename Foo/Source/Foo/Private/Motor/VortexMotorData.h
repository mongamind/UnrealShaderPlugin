...
class FVortexMotorParam : public FWindMotorBaseParamBase
{
public:
	virtual ~FVortexMotorParam() override{}
	virtual EWindMotorType GetWindMotorType() const override {return WMT_Vortex;};
};


BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FVortexMotorUniformData, )
...
class FVortexMotorShader : public FGlobalShader
{
	DECLARE_SHADER_TYPE(FVortexMotorShader, Global);
public:

	FVortexMotorShader() {}

	FVortexMotorShader(const ShaderMetaType::CompiledShaderInitializerType& Initializer);
