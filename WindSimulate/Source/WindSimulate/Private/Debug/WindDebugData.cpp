...
IMPLEMENT_SHADER_TYPE(, FWindDebugXYZAxisShaderVS, TEXT("/Plugin/WindSimulate/Private/ComputeShader/Debug/WindDebugXYZAxis.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FWindDebugXYZAxisShaderPS, TEXT("/Plugin/WindSimulate/Private/ComputeShader/Debug/WindDebugXYZAxis.usf"), TEXT("MainPS"), SF_Pixel)

IMPLEMENT_SHADER_TYPE(, FWindDebugTex3DShaderVS, TEXT("/Plugin/WindSimulate/Private/ComputeShader/Debug/WindDebugTex3D.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FWindDebugTex3DShaderPS, TEXT("/Plugin/WindSimulate/Private/ComputeShader/Debug/WindDebugTex3D.usf"), TEXT("MainPS"), SF_Pixel)

// IMPLEMENT_SHADER_TYPE(, FWindDebugXYZAxisShaderVS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyColorShader.usf"), TEXT("MainVS"), SF_Vertex)
// IMPLEMENT_SHADER_TYPE(, FWindDebugXYZAxisShaderPS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyColorShader.usf"), TEXT("MainPS"), SF_Pixel)
