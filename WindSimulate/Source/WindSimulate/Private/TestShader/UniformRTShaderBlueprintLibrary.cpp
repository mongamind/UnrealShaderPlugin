...
IMPLEMENT_SHADER_TYPE(, FMyUniformShaderVS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyUniformShader.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FMyUniformShaderPS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyUniformShader.usf"), TEXT("MainPS"), SF_Pixel)
