...
IMPLEMENT_SHADER_TYPE(, FMyTextureShaderVS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyTextureShader.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FMyTextureShaderPS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyTextureShader.usf"), TEXT("MainPS"), SF_Pixel)


// IMPLEMENT_SHADER_TYPE(, FMyTextureShaderVS, TEXT("/Plugin/WindSimulate/Private/ComputeShader/Debug/WindDebugSamplePlane.usf"), TEXT("MainVS"), SF_Vertex)
// IMPLEMENT_SHADER_TYPE(, FMyTextureShaderPS, TEXT("/Plugin/WindSimulate/Private/ComputeShader/Debug/WindDebugSamplePlane.usf"), TEXT("MainPS"), SF_Pixel)
