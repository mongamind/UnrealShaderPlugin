...
IMPLEMENT_SHADER_TYPE(, FMyComputeShaderShader, TEXT("/Plugin/WindSimulate/Private/TestShader/MyComputeShader.usf"), TEXT("MainCS"), SF_Compute)
IMPLEMENT_SHADER_TYPE(, FMyTestShaderVS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyTextureShader_ForComputeShaderTest.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FMyTestShaderPS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyTextureShader_ForComputeShaderTest.usf"), TEXT("MainPS"), SF_Pixel)
