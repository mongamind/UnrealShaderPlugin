...
IMPLEMENT_SHADER_TYPE(, FMyShaderVS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyColorShader.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FMyShaderPS, TEXT("/Plugin/WindSimulate/Private/TestShader/MyColorShader.usf"), TEXT("MainPS"), SF_Pixel)
