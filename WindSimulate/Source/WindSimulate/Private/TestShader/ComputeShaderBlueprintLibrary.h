...
#include "ComputeShaderBlueprintLibrary.generated.h"


USTRUCT(BlueprintType)
struct FMyComputeShaderCPPData
{
	GENERATED_BODY()
...
BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FMyComputeShaderStructData, )
...
class UComputeShaderBlueprintLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_UCLASS_BODY()
	
	
	UFUNCTION(BlueprintCallable, Category = "WindSimulate", meta = (WorldContext = "WorldContextObject"))
	static void UseComputeShaderToDraw(
